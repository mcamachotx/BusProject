...
function addButtons() {
    ...
    document.getElementById('btnBycicle').addEventListener('click', function () {
        var bycicleLayer = new google.maps.BicyclingLayer();
        bycicleLayer.setMap(map);
    });
